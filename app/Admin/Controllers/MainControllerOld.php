...
class MainControllerOld extends BaseController
{
  ...
  function generate_class()
  {
    ...
    //$array = preg_split('/\r\n|\n\r|\r|\n/', $data);
    $array = explode(',', $data);
    $generate_vars = MainControllerOld::generate_vars($array);
    $fromJson = MainControllerOld::fromJson($array);
    $from_json = MainControllerOld::from_json($array);
    $toJson = MainControllerOld::to_json($array);
    $create_table = MainControllerOld::create_table($array, $modelName);
    return <<<EOT
<pre>
...
EOT;
    ...
    return view('generate-class', [
      'modelName' => $modelName,
      'endPoint' => $endPoint,
      'fromJson' => MainControllerOld::fromJson($vars),
    ]);
  }
  ...
  function generate_variables($data)
  {
    ...
    MainControllerOld::createNew($recs);
    MainControllerOld::from_json($recs);
    MainControllerOld::fromJson($recs);
    MainControllerOld::generate_vars($recs);
    MainControllerOld::create_table($recs, 'people');
    //MainControllerOld::to_json($recs);
  }
