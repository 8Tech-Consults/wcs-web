...
class SecretariesController extends AdminController
{
    /**
     * {@inheritdoc}
     */
 ...
 */
    ...
    public function form()
    {
        ...
        $u = Auth::user();
        $form->hidden('secretary_to_id', 'ID')->default($u->id);
        ...
        $form->select('pa_id', __('Duty station'))
            ...
            ->default($u->pa_id)
            ->readOnly()
            ->help('Protected area where  secretary is assigned')
        ...
        $form->multipleSelect('roles', trans('admin.roles'))->options($roleModel::where('slug', 'secretary')->get()->pluck('name', 'id'))
            ->default([9])->readOnly();
